report 50004 "Cashier Accountability Report"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultRenderingLayout = LayoutName;
    Caption = 'Cashier Accountability Report';
    dataset
    {
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = 'src\report\Layout\Cashier Accountability Report.rdl';
        }
    }
        ...
        case Mode of
            1://ZeroRatedAmount
                begin
                    ...
                    Transheader.SetRange("Staff ID", Staff);
            ...
            2://VatableSales
                begin
                    ...
                    salesEntry.SetRange("Staff ID", Staff);
            ...
            5://Zero-rated Sales
                begin
                    ...
                    salesEntry.SetRange(Date, vDateFilter);
                    salesEntry.SetRange("POS Terminal No.", codTerminal);
                    salesEntry.SetRange(salesEntry."Staff ID", Staff);
        ...
        CASE pMode OF
            1:
                begin
                    ...
                    PaymEntry.SetRange("Staff ID", Staff);
        ...
        CASE pMode OF
            1://Gross Sales
                begin
                    ...
                    transactionheader.SetRange("Staff ID", Staff);
            ...
            12://No. of Suspended
                begin
                    ...
                    SuspTrans.SetRange("Staff ID", Staff);
            ...
            13://intLTotalNoOfVoidLine
                begin
                    ...
                    POSVoidedLine.SetRange(POSVoidedLine."Created by Staff ID", Staff);
    ...
    var
        ...
        FloatEntry, RemoveTender, ZeroRatedAmount, VatableSales, VATAmount, VATExemptSales, ZeroratedSales, TotalVatDetails : decimal;
